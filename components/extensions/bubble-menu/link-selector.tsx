  ...
  return (
    <div className="relative">
      ...
      {isOpen && (
        ...
        >
          <input ref={inputRef} type="text" placeholder="Paste a link" className="flex-1 bg-white p-1 text-sm outline-none text-black" defaultValue={editor.getAttributes("link").href || ""} />
